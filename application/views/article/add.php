<form action="<?php echo base_url()."index.php/Article/add" ?>" method="POST">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="paragraph1" value="<?php echo $this->input->post('paragraph1'); ?>" class="form-control" id="paragraph1" />
		</div>
	</div>
	<div class="form-group">
		<label for="paragraph2" class="col-md-4 control-label">Paragraph2</label>
		<div class="col-md-8">
			<input type="text" name="paragraph2" value="<?php echo $this->input->post('paragraph2'); ?>" class="form-control" id="paragraph2" />
		</div>
	</div>
	<div class="form-group">
